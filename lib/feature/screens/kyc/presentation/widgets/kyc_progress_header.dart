...
class KycProgressHeader extends StatelessWidget {
  const KycProgressHeader({super.key, required this.currentStep, required this.totalSteps, required this.sectionLabel, this.onBack, this.onSkip});
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: Text(AppStrings.kyc.appBarTitle, style: AppTypography.headingSM(color: AppColors.textPrimaryLight)),
            ),
            InkWell(
              onTap: onSkip,
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(AppStrings.kyc.skip, style: AppTypography.labelMedium(color: AppColors.maroonPrimary)),
                    SizedBox(width: 2.w),
                    Icon(Icons.arrow_forward, size: 14.sp, color: AppColors.maroonPrimary),
                  ],
                ),
              ),
            ),
        ...
        Padding(
          ...
          child: Text('Step $currentStep of $totalSteps • $sectionLabel', style: AppTypography.caption(color: AppColors.textMutedLight)),
        ),
        ...
        Row(
          children: [
                ...
                children: List.generate(totalSteps, (i) {
                  ...
                  return Expanded(
                    child: Container(
                      ...
                      height: 5.h,
                      decoration: BoxDecoration(color: filled ? AppColors.maroonPrimary : AppColors.borderLight, borderRadius: BorderRadius.circular(AppSpacing.radiusFull)),
                    ),
                  );
                }),
              ),
            ...
            Text('$percent%', style: AppTypography.labelSmall(color: AppColors.textPrimaryLight)),
          ],
        ),
      ],
    );

        ...
        return Theme(
          data: Theme.of(context).copyWith(
            ...
            datePickerTheme: DatePickerThemeData(
              ...
              todayForegroundColor: WidgetStatePropertyAll(AppColors.maroonPrimary),
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: [
          _KycBanner(icon: Icons.badge_outlined, title: AppStrings.kyc.bannerTitle, subtitle: AppStrings.kyc.bannerSubtitle),
            ...
            child: GestureDetector(
              ...
              child: Column(
                children: [
                  ...
                  Text(AppStrings.kyc.addProfilePicture, style: AppTypography.labelMedium(color: AppColors.maroonPrimary)),
                ],
              ),
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(AppStrings.kyc.personalDetailsTitle, style: AppTypography.sectionTitleSM(color: AppColors.textPrimaryLight)),
                      ...
                      child: GestureDetector(
                        ...
                        child: AbsorbPointer(
                          child: AppTextField(
                            ...
                            suffixIcon: Icon(Icons.calendar_today_outlined, size: AppSpacing.iconSm, color: AppColors.mutedGray),
                ...
                SizedBox(height: AppSpacing.lg),
                AppTextField(label: AppStrings.kyc.mobileLabel, hintText: AppStrings.kyc.mobileHint, controller: mobileController, keyboardType: TextInputType.phone, prefixIcon: Icons.phone_outlined),
              ],
            ),
          ),
        ],
...
class _KycBanner extends StatelessWidget {
  const _KycBanner({required this.icon, required this.title, required this.subtitle});
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: AppColors.textOnGold, size: AppSpacing.iconMd),
          ),
          SizedBox(width: AppSpacing.md),
          Expanded(
            child: Column(
